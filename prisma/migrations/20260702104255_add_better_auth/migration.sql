/*
  ...
  - The primary key for the `product_files` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- DropIndex
DROP INDEX "product_files_id_key";
